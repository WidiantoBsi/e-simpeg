        ...
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/riwayat_pendidikan/simpan/<?php echo isset($id)?$id:''; ?>" method="post" name="submit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                    <input required type="text" class="form-control" id="tanggal_ijazah" name="tanggal_ijazah" value="<?php echo set_value('tanggal_ijazah');?>" placeholder="Tanggal Ijazah">
                </div><br><br>
                </div>
                <div class="form-group">
						...
						<div class="row text-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  						...
  						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th data-field="tingkat_pendidikan" data-align="left" data-sortable="true">Tingkat Pendidikan</th>
								<th data-field="kota" data-align="left" data-sortable="true">Kota</th>
								<th data-field="jurusan" data-align="left" data-sortable="true">Jurusan</th>
								<th data-field="tanggal_ijazah" data-align="left" data-sortable="true">Tanggal Ijazah</th>
								<th data-field="tahun_masuk" data-align="left" data-sortable="true">Tahun Masuk</th>
								<th data-field="tahun_lulus" data-align="left" data-sortable="true">Tahun Lulus</th>
							...
							<a href="<?php echo base_url();?>index.php/riwayat_pendidikan/edit/<?php echo $row->id;?>" >
