        ...
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/pegawai/simpan/<?php echo isset($id)?$id:''; ?>" method="post" name="submit">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                    <input required type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo set_value('tanggal_lahir');?>" placeholder="tanggal_lahir">
                	</div><br><br>
                </div>
                <div class="form-group">
					...
					<div class="panel-body">
                        ...
                        <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th data-field="nip" data-align="left" data-sortable="true">NIP</th>
								<th data-field="nama" data-align="left" data-sortable="true">Nama</th>
								<th data-field="jenis_kelamin" data-align="left" data-sortable="true">Jenis Kelamin</th>
								<th data-field="status" data-align="left" data-sortable="true">Status</th>
								<th data-field="agama" data-align="left" data-sortable="true">Agama</th>
								<th data-field="tempat_lahir" data-align="left" data-sortable="true">Tempat Lahir</th>
								<th data-field="tanggal_lahir" data-align="left" data-sortable="true">Tanggal Lahir</th>
								<th data-field="alamat" data-align="left" data-sortable="true">Alamat</th>
								<th data-field="telepon" data-align="left" data-sortable="true">Telepon</th>
							...
							<a href="<?php echo base_url();?>index.php/pegawai/edit/<?php echo $row->id;?>" >
